...
public class TimePickerView extends BasePickerView implements View.OnClickListener {
    ...
    private void initView(Context context) {
        ...
        if (mPickerOptions.customListener == null) {
            ...
            tvTitle.setText(TextUtils.isEmpty(mPickerOptions.textContentTitle) ? context.getResources().getString(R.string.pickerview_title) : mPickerOptions.textContentTitle); // 默认为空
        } else {
    ...
    private void initWheelTime(LinearLayout timePickerView, Context context) {
        int contentSize = context.getResources().getInteger(R.integer.pickerview_textsize);
        wheelTime = new WheelTime(timePickerView, mPickerOptions.type, mPickerOptions.textGravity, contentSize);
    ...
    private void initDefaultSelectedDate() {
        ...
        if (mPickerOptions.startDate != null && mPickerOptions.endDate != null) {
            ...
            if (mPickerOptions.date == null || mPickerOptions.date.getTimeInMillis() < mPickerOptions.startDate.getTimeInMillis() || mPickerOptions.date.getTimeInMillis() > mPickerOptions.endDate.getTimeInMillis()) {
