...
public class WheelView extends View {
    ...
    public WheelView(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            textColorOut = a.getColor(R.styleable.WheelView_wheelview_textColorOut, 0x1EFFFFFF);
            textColorCenter = a.getColor(R.styleable.WheelView_wheelview_textColorCenter, 0xFFFFFFFF);
            dividerColor = a.getColor(R.styleable.WheelView_wheelview_dividerColor, 0x1F000000);
        ...
        while (counter < itemsVisible) {
            ...
            if (angle >= 90F || angle <= -90F) {
                ...
                if (translateY <= firstLineY && maxTextHeight + translateY >= firstLineY) {
                    ...
                    canvas.scale(1.0F, (float) Math.sin(radian) * SCALE_CONTENT);
                    // 控制文字倾斜角度
                    paintOuterText.setTextSkewX((Integer.compare(textXOffset, 0)) * (angle > 0 ? -1 : 1) * 0.5f * offsetCoefficient);
                    // 控制透明度
